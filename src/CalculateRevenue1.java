 ...
 * @author 123
 */
public class CalculateRevenue1 extends javax.swing.JFrame {
ManagerLogin m; 
    /**
     * Creates new form CalculateRevenue1
     */
    public CalculateRevenue1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        RevenueLabel.setText("SP Revenue Calculator");
        ...
        RevenueTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PurchaseID", "Date", "DealerID", "total"
            }
        ) {
...
ToTextBox.setToolTipText("yyyy-mm-dd");
        ...
        try {
            String query="SELECT * FROM `purchase` WHERE `Date` BETWEEN ? AND ?";
            ...
            while(rs.next())
            {
                Object o[]={rs.getInt("PurchaseID"), rs.getTimestamp("Date"), rs.getInt("DealerID"),rs.getInt("total")};
                tm.addRow(o);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculateRevenue1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculateRevenue1().setVisible(true);
            }
        });
    }
